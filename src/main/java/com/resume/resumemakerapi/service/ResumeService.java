...
public class ResumeService {
    ...
    private StringBuilder getResumeData1(AllModel model){
        ...
        sb.append("<table style='width:100%'><tr><td class='pt-2' style='width:42%'><div class='text-center mb-2'>");
        sb.append("<img class='resume1-photo' src='"+model.getProfilePic()+"' alt='my photo'>");
        sb.append("</div><div class='line m-0'></div><h4 class='mt-3 mb-2'>GET IN TOUCH!</h4>");
